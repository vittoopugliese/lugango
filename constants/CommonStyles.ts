...
export const products = [
  ...
  },
  {
    ...
    image: require("../assets/images/cart-image.png"),
    description:
      "Gummy Bears by Elemental Wellness are a delicious way to medicate. These tasty gummies come in a variety of flavors and are infused with 10mg of THC per piece. Great for on-the-go or sharing with friends!", 
  },
  {
    category: "Edibles",
    quantity: 0,
    ...
    image: require("../assets/images/cart-image.png"),
    description:
      "Chocolate Chip Cookies by Elemental Wellness are a delicious way to medicate. These tasty cookies come in a variety of flavors and are infused with 10mg of THC per piece. Great for on-the-go or sharing with friends!", 
  },
  {
    category: "Edibles",
    quantity: 0,
    ...
    image: require("../assets/images/cart-image.png"),
    description:
      "Brownies by Elemental Wellness are a delicious way to medicate. These tasty brownies come in a variety of flavors and are infused with 10mg of THC per piece. Great for on-the-go or sharing with friends!", 
  },
  {
    category: "Edibles",
    quantity: 0,
    ...
    image: require("../assets/images/cart-image.png"),
    description:
      "Rice Krispie Treats by Elemental Wellness are a delicious way to medicate. These tasty treats come in a variety of flavors and are infused with 10mg of THC per piece. Great for on-the-go or sharing with friends!", 
  },
  {
    category: "Extracts",
    quantity: 0,
    ...
    image: require("../assets/images/cart-image.png"),
    description:
      "Shatter by Elemental Wellness is a delicious way to medicate. These tasty shatter come in a variety of flavors and are infused with 70% of THC per piece. Great for on-the-go or sharing with friends!",
  }
];
